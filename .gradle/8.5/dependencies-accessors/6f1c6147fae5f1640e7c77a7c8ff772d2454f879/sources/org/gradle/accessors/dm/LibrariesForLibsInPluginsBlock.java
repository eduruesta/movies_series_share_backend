...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KtorSerializationLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorSerializationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for gson (io.ktor:ktor-serialization-gson-jvm)
    ...
    public static class KtorServerLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorServerTomcatLibraryAccessors laccForKtorServerTomcatLibraryAccessors = new KtorServerTomcatLibraryAccessors(owner);
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for swagger (io.ktor:ktor-server-swagger-jvm)
         * with versionRef 'ktor.version'.
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        ...
        /**
         * Returns the group of libraries at ktor.server.tomcat
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorServerTomcatLibraryAccessors getTomcat() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorServerTomcatLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorServerTomcatLibraryAccessors extends SubDependencyFactory {

        public KtorServerTomcatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for jakarta (io.ktor:ktor-server-tomcat-jakarta-jvm)
         * with versionRef 'ktor.version'.
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("ktor.server.tomcat.jakarta");
        }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  {
        ...
        public KotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.version (2.0.20)
